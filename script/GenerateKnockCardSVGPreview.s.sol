...
contract GenerateKnockCardSVGPreview is Script {
    function run() external {
        ...
        // No bio
        _generateCard(card, metadata, address(0x2001), "NoBio", "", "@nobio", "", "", 15, 10, 5, 2, "edge_no_bio");

        // Short bio
        _generateCard(
            card, metadata, address(0x2002), "ShortBio", "Hi!", "@shortbio", "", "", 20, 10, 5, 2, "edge_short_bio"
        );
        ...
        // No socials at all
        _generateCard(
            card, metadata, address(0x3005), "NoSocials", "No social links.", "", "", "", 18, 20, 15, 2, "social_none"
        );
        ...
        _generateCard(
            ...
            999,
            888,
            77, // 8888 received - influencer level
            "stats_high"
        );
        ...
        _generateCard(
            ...
            20,
            0,
            20, // Only 5 received - not popular
            "stats_all_rejected"
        );
        ...
        // Absolutely minimal
        _generateCard(card, metadata, address(0x6001), "Min", "", "", "", "", 0, 0, 0, 0, "minimal");
        ...
        _generateCard(
            ...
            "@maximaluser123",
            "maximaluser123456789",
            "https://maximal-website-url-example.com/path/to/page",
            5000,
            200,
            180,
            10, // 5000 received
...
contract MockKnockProtocol {
    ...
    function setCardStats(address user, uint256 ethReceived, uint256 sent, uint256 accepted, uint256 rejected)
        external
    {
